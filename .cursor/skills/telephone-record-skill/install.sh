...
echo "快速开始:"
echo "  cd $SCRIPT_DIR"
echo "  python3 scripts/handler.py doctor   # 诊断数据库连通性"
echo "  python3 scripts/handler.py types    # 查看录音类型"
echo "  python3 scripts/handler.py query telsales --date today  # 查询电销录音"
echo "=================================="
